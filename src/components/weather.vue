      ...
      <div class="container">
        <div class="item">
          <span :style="{ color: color }"
            ...
            {{ Math.round(data.data.main.temp) }}°C</span
          >
          <br />
          <span :style="{ color: color }"
            ><svg
            ...
            {{ Math.round(data.data.main.feels_like) }}°C</span
          >
          <br />
          <span :style="{ color: color }"
            ><svg
            ...
            {{ Math.round(data.data.main.temp_min) }}°C</span
          >
          <br />
          <span :style="{ color: color }"
            ><svg
            ...
            {{ Math.round(data.data.main.temp_max) }}°C</span
          >
        </div>
        <div class="item">
          <span :style="{ color: color }"
